...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('webapp', '0004_alter_topic_author'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topics', to='webapp.topic', verbose_name='Тема')),
            ],
        ),
    ]
